...
kafka.producer.jsonfile=/mnt/c/Users/chenxilin/Code/all_about_java/flink/src/main/resources/chenxilin.json
...
## 3.运行flink任务
```shell
flink run -c org.chenxilin.flink.cases.kafkaproducetool.Main flink-1.0-SNAPSHOT.jar chenxilin.properties 127.0.0.1:9000
```